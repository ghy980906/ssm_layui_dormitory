...
<body onload="showtime()" background="${ctx}/image/back_01.png">
<div class="b">
    <span id="clock" style="color:#0000FF"></span>
</div>
<h1>欢迎登录</h1>
<div class="wrap">
    <img src="${ctx}/image/11.jpg" alt=""> <span><strong>学生公寓管理系统</strong>
		</span>
</div>
<h2>当前登录：${admin.nickname }${hotel_user.username}</h2>
<%--<div class="c">--%>
