...
<!--数据表格-->
<table id="myFixList" class="myFixList" lay-filter="myFixList"></table>
<script type="text/javascript" src="${ctx }/layui/layui.js"></script>
<script type="text/javascript" src="${ctx }/js/fix/myFixList.js"></script>
